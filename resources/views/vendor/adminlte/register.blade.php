        ...
        <div class="register-box-body">
            ...
            <form action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
                ...
                <div class="form-group has-feedback {{ $errors->has('ra') ? 'has-error' : '' }}">
                    <input type="text" name="ra" class="form-control" value="{{ old('ra') }}" placeholder="RA">
                    <span class="glyphicon glyphicon-tags form-control-feedback"></span>
                    @if ($errors->has('ra'))
                        <span class="help-block"><strong>{{ $errors->first('ra') }}</strong></span>
                    @endif
                </div>
                ...
                <div class="form-group has-feedback {{ $errors->has('campus') ? 'has-error' : '' }}">
                    <select name="campus" class="form-control">
                        <option value="dis" disabled selected>Campus</option>
                        <option value="bra">Bragança Paulista</option>
                        <option value="cam">Campinas</option>
                    </select>
